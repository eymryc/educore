...
export const ADMIN_NAV_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { id: "academic-structure", label: "Structure académique", icon: "account_tree", href: "/academic/structure" },
    ],
  },
  {
    title: "Scolarité",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "fees", label: "Frais", icon: "sell", href: "/finance/fees" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "canteen-accounts", label: "Comptes", icon: "account_balance", href: "/canteen/accounts" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "security", label: "Sécurité", icon: "shield", href: "/security/audit-logs" },
...
const CRUD_RESOURCE_TO_NAV: Record<string, string> = {
  ...
  "academic-periods": "/academic/structure",
  "academic-holidays": "/academic/structure",
  levels: "/academic/structure",
  series: "/academic/structure",
  "class-subjects": "/academic/structure",
