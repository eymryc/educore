...
export const PAGE_ROUTES: PageRouteConfig[] = [
  ...
  { folder: "academic_structure", route: "academic/structure", layout: "admin", activePath: "academic-structure", componentName: "AcademicStructureContent", title: "Structure académique" },
  ...
  { folder: "security_audit_logs", route: "security/audit-logs", layout: "admin", activePath: "security", componentName: "SecurityAuditLogsContent", title: "Journal d'audit de sécurité" },
